                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center justify-content-center bg-gray-100 ht-md-80 bd pd-x-20">
                            <form action="{{ route('update.brand') }}" method="POST" class="d-md-flex pd-y-20 pd-md-y-0">
                                @csrf
                                <input type="hidden" name="id" value="{{ $brand->id }}">
                                <input type="text" class="form-control @error('brand_name') is-invalid @enderror" name="brand_name" placeholder="Brand Name" value="{{ $brand->brand_name }}">
                                @error('brand_name')
