                ...
                <div class="col-lg-3 col-md-5">
                    <div class="sidebar">
                        <div class="sidebar__item">
                            ...
                            <ul>
                                @foreach ($categories as $item)
                                    <li><a href="{{ $item->cat_slug }}">{{ $item->cat_name }}</a></li>
                                @endforeach
                            </ul>
                        </div>
                        <!--div class="sidebar__item">
                    ...
                    <div class="product__discount">
                        ...
                        <div class="row">
                            <div class="product__discount__slider owl-carousel">
                                @foreach ($sell_off as $item)
                                <div class="col-lg-4">
                                    <div class="featured__item">
                                        <div class="featured__item__pic set-bg"
                                            data-setbg="{{ asset('uploads/products/'.$item->image_one) }}">

                                            <div style="height: 45px;width: 45px;background: #dd2222;border-radius: 50%;font-size: 14px;
                                                color: #ffffff;
                                                line-height: 45px;
                                                text-align: center;
                                                position: absolute;
                                                ...
                                                top: 15px;">
                                                @php
                                                    $lossTk = $item->product_price - $item->discount_price;
                                                @endphp

                                                {{
                                                    round($lossTk*100/$item->product_price)
                                                 }}%
                                        ...
                                        <div class="product__discount__item__text">
                                            ...
                                            <h5><a href="{{ route('details',$item->product_slug) }}">{{ $item->product_name }}</a></h5>
                                        ...
                                        <li>
                                            <form action="{{ url('add/to-cart/'.$item->id) }}" method="post">
                                                ...
                                                @if ($item->discount_price == NULL)
                                                    <input type="hidden" value="{{ $item->product_price }}" name="price">
                                                @else
                                                    <input type="hidden" value="{{ $item->discount_price }}" name="price">
                                ...
                                <div class="featured__item__text">
                                    ...
                                    <div class="product__item__price">
                                        ...
                                        @else
                                            ...
                                            <del><span>&#2547;{{ $item->product_price }}</span></del>
